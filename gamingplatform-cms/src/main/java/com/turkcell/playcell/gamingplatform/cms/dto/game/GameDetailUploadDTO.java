...
public class GameDetailUploadDTO {

    @NotNull
    private Long platformId;

    @NotNull
    private List<GameDetailTranslationCreateDTO> gameDetailTranslations;
    ...
    public List<GameDetailTranslationCreateDTO> getGameDetailTranslations() {
        return gameDetailTranslations;
    }

    public void setGameDetailTranslations(List<GameDetailTranslationCreateDTO> gameDetailTranslations) {
